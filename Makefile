.PHONY: deploy
DOCKER_REPOSITORY=lc3-bos201:5050
...
docker-rabbitmq:
	docker pull $(RABBITMQ_IMAGE_NAME) || docker build -t $(RABBITMQ_IMAGE_NAME) $(RABBITMQ_DOCKER_DIR) && docker push $(RABBITMQ_IMAGE_NAME)
