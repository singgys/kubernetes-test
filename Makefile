...
docker-rabbitmq:
	$(SUDO) docker pull $(DOCKER_REPOSITORY)/$(RABBITMQ_IMAGE_NAME):$(RABBITMQ_IMAGE_TAG) || $(SUDO) docker build -t $(RABBITMQ_IMAGE_NAME):$(RABBITMQ_IMAGE_TAG) $(RABBITMQ_DOCKER_DIR) && $(SUDO) docker tag $(RABBITMQ_IMAGE_NAME):$(RABBITMQ_IMAGE_TAG) $(DOCKER_REPOSITORY)/$(RABBITMQ_IMAGE_NAME):$(RABBITMQ_IMAGE_TAG) && $(SUDO) docker push $(DOCKER_REPOSITORY)/$(RABBITMQ_IMAGE_NAME):$(RABBITMQ_IMAGE_TAG)
